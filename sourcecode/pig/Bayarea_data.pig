...
D = FILTER C BY $1 != '0.0' AND $2 != '0.0' AND ($4 IS NULL OR (double)$4 < 2) AND (double)$2 > -122.279131 AND (double)$2 < -121.736096 AND (double)$1 > 37.218601 AND (double)$1 < 37.570835;
...
STORE FINAL2 into 's3://data-engineering-interns/chen/output/Bayarea_August';