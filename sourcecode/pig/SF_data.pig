...
raw_data = LOAD 's3://data-engineering-team-bucket/beacon_logs/year=2014/month=8/day=2*/*/*' using com.twitter.elephantbird.pig.load.JsonLoader() as (json: map[]);
...
D = FILTER C BY $1 != '0.0' AND $2 != '0.0' AND ($4 IS NULL OR (double)$4 < 2) AND (double)$2 > -122.518631 AND (double)$2 < -122.378727 AND (double)$1 > 37.666163 AND (double)$1 < 37.813777;
...
STORE FINAL2 into 's3://data-engineering-interns/chen/output/SF_August_week';