...
// load the data in August from ec2
...
// Filter out the data with speed bigger than 2, the $4 is the velocity feature and limit the area within a bounding box with the given latitude and longitude border
...
STORE FINAL2 into 's3://data-engineering-interns/chen/output/myoutput';
